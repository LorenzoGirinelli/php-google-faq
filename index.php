<?php 
    $faq = [
        ...
        [
            ...
            'answer' => [
                'I risultati di ricerca di Google rispecchiano i contenuti pubblicamente disponibili sul Web. I motori di ricerca non possono rimuovere i contenuti direttamente <br> dai siti web, quindi rimuovere risultati di ricerca da Google non consente di rimuovere i contenuti dal Web. Se desideri rimuovere qualcosa dal Web, devi <br> <a href="#">contattare il webmaster</a> del sito su cui sono pubblicati i contenuti e chiedergli di apportare una modifica. Inoltre, se, ai sensi delle leggi europee per la <br> protezione dei dati, desideri richiedere la rimozione di determinate informazioni su di te visualizzate nei risultati di ricerca di Google, <a href="#">fai clic</a> qui. Una volta che i <br> contenuti saranno stati rimossi e che Google avrà rilevato l\'aggiornamento, le informazioni non verranno più visualizzate nei risultati di ricerca di Google. In <br> caso di una richiesta di rimozione urgente, è inoltre possibile <a href="#">visitare la nostra pagina di assistenza per avere ulteriori informazioni</a>.',
            ]
        ],
    ];
?>
...
<body>
    ...
    <header>
        ...
        <div class="top">
            <!-- Logo  -->
            <div class="left">
                <span><img src="https://www.pngmart.com/files/16/official-Google-Logo-PNG-Clipart.png" alt="google logo"></span>
                <span class="title">Privacy e termini</span>
            </div>

            <!-- Account  -->
            <div class="left">
                <span class="appGoogle">
                    <i class="fas fa-th"></i>
                </span>
                <span class="account">L</span>
            </div>
        </div>
                    ...
                    <?php foreach ($single_faq['answer'] as $single_answer) { ?>
                        ...
                        <?php } else { ?>
                            <ol class="answer single-answers">
                                <?php foreach ($single_answer as $other_answer) { ?>
                                    <?php if (!is_array($other_answer)) { ?>
                                        <li><?php echo $other_answer; ?></li>
                                    <?php } else { ?>
                                        <ol class="answer a-b">
                                            <?php foreach ($other_answer as $a_b) { ?>
                                                <li><?php echo $a_b; ?></li>
                                            <?php } ?>
                                        </ol>
                                    <?php } ?>
